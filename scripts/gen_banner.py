...
TPL = r'''<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="400" viewBox="0 0 1200 400" role="img" aria-label="{TITLE} — ONAR-77. {SUBTITLE}">
  ...
  <g class="scorp2" transform="translate(116,266) scale(.62)"> fill="none" stroke="{NAVY}" stroke-width="3.4" stroke-linecap="round">
  ...
  <text x="226" y="292" class="arr arr2">→</text>
  <g class="eagle2" transform="translate(292,280) scale(.38)">
  ...
  <text x="352" y="292" class="arr arr2 arr2b">→</text>
  <g class="phx2" transform="translate(420,280) scale(.38)">
